...
- [Hands-on lab: Strapi on GKE Autopilot](../labs/Strapi_GKE.md) — deploy it step by step, with the console screens and commands at each stage.
- [Strapi on Google Cloud Run](Strapi_CloudRun.md) — the same application on Cloud Run, for when you need the other deployment target.
