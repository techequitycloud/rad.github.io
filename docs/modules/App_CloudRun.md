...
| `deployment_id` | `""` (let the platform auto-generate; never set manually) | **Critical** | If manually set and later changed, every resource suffixed with this ID is destroyed and recreated. Auto-generated values are stable across applies. |
