...
- **Services_GCP** (provides the VPC, GKE Autopilot cluster, Artifact Registry,
  and shared service accounts this module depends on — Kavita itself needs no
  Cloud SQL). You do not need to deploy this yourself first — the platform
...
1. Open **Solutions → Solution Modules** in the RAD platform top navigation, open **Kavita (GKE)**
