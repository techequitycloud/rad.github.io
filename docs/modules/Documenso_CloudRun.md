...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/Documenso_CloudRun.png" alt="Documenso on Google Cloud Run" style={{maxWidth: "100%", borderRadius: "8px"}} />
