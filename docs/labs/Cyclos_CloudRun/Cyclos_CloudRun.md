...
1. **Services GCP module deployed** — Cyclos CloudRun depends on `Services GCP` for the VPC network, Cloud SQL instance, and Artifact Registry. The `module_dependency` variable confirms this: `["Services GCP"]`.
...
| Phase 9 — Delete | AUTOMATED | RAD UI Delete removes all resources |
