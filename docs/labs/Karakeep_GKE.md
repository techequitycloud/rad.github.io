...
- **Services_GCP** (provides the VPC, GKE Autopilot cluster, NFS/Filestore,
...
instead (from the same **Delete** dialog) — it removes the deployment from RAD's records **without** destroying
