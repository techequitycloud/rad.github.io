...
<img src="https://storage.googleapis.com/rad-public-2b65/certification/pde_section5.png" alt="PDE Certification Preparation Guide: Section 5 — Optimizing performance and cost (~12% of the exam)" style={{maxWidth: "100%", borderRadius: "8px"}} />
