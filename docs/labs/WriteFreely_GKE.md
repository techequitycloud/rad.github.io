...
1. Open **Solutions → Solution Modules** in the RAD platform top navigation, open **WriteFreely
...
makes RAD forget the deployment). This removes everything the module created — the
