...
<AudioPlayer url="https://storage.googleapis.com/rad-public-2b65/guides/start_guide.m4a" title="Getting Started Audio" />
...
## 1. Introduction
Welcome to the Rapid Application Deployment (RAD) platform! This guide will walk you through your first steps: logging in, exploring the dashboard, and deploying your first module.
...
4.  **Success!** You will be redirected to the **Deployments** page (or your role-specific home page).
    *   *Tip:* If you are a new user, check your notification area—you might have received free "Sign-up Credits"!

## 3. Step 2: Explore the Dashboard
...
3.  Browse the cards or use the **Search** bar to find a module (e.g., "Simple Website").
4.  Click the card to start the configuration.
5.  **Configure:** You'll see a configuration form.
    *   Enter a unique **Project ID**.
    *   Select a **Region** (e.g., `us-central1`).
    *   *Note:* The form may have multiple steps. Click **Next** to proceed through them.
6.  Click **Submit**.
7.  **Confirm:** Review the credit cost on the popup modal and click **Confirm**.
...
Congratulations! You have successfully deployed your first module.
