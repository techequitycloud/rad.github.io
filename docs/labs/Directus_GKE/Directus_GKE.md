...
> **Note:** `enable_purge = true` (the default) ensures all resources including GCS buckets and the Cloud SQL instance are deleted. Set `enable_purge = false` before deleting if you want to retain data.
