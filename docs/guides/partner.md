...
<YouTubeEmbed videoId="TMfX7T_z3bk" poster="https://storage.googleapis.com/rad-public-2b65/guides/partner_guide.png" />
...
*   **Tracking:** Module revenue reports are available on the **Revenue** page under the **Module Revenue** tab. Access to this page requires the **Agent** role to be assigned to your account by an Administrator. If you do not currently have the Agent role, contact your Administrator to request it. If access cannot be granted, the Finance team can provide revenue statements directly.
