...
| `resource_creator_identity` | `"rad-module-creator@tec-rad-ui-2b65.iam.gserviceaccount.com"` | Service account email | Service account used by Terraform to create and manage resources. Override with a project-specific service account for production deployments. |
