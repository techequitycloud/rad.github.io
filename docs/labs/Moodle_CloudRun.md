...
description: "Hands-on lab: deploy Moodle on Cloud Run in your own Google Cloud project — guided setup, verification, operations, observability, and teardown."
---
...
- **Services_GCP** (provides the VPC, Cloud SQL, Filestore NFS, Redis, Artifact
...
1. Open **Solutions → Solution Modules** in the RAD platform top navigation, open **Moodle (Cloud Run)** from the **Platform Modules** list to start configuration, set `project_id`, and review the
