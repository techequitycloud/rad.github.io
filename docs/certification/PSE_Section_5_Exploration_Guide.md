...
<img src="https://storage.googleapis.com/rad-public-2b65/certification/pse_section5.png" alt="PSE Certification Preparation Guide: Section 5 — Supporting compliance requirements (~11% of the exam)" style={{maxWidth: "100%", borderRadius: "8px"}} />
