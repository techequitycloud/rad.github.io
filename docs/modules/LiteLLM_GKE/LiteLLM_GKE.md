---
title: "LiteLLM on Google Kubernetes Engine (GKE Autopilot)"
...
Same as `LiteLLM CloudRun`. See [LiteLLM CloudRun §3.B](../LiteLLM_CloudRun/LiteLLM_CloudRun.md#b-database-cloud-sql--postgresql-15).
...
Same variables as `LiteLLM CloudRun`. See [LiteLLM CloudRun §3.E](../LiteLLM_CloudRun/LiteLLM_CloudRun.md#e-storage) and [§3.F](../LiteLLM_CloudRun/LiteLLM_CloudRun.md#f-networking).
