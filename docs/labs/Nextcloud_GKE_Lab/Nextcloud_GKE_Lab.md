---
title: "Nextcloud on GKE — Lab Guide"
sidebar_label: "Nextcloud GKE Lab"
---
...
Resources provisioned by `Services_GCP` (VPC, GKE cluster, Cloud SQL instance) must be undeployed separately.
