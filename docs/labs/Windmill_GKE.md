...
1. Click **Modules** in the RAD platform top navigation, open **Windmill (GKE)** from the **Platform Modules** list to start configuration, set `project_id`, and review the inputs.
...
2. The platform deploys the workload into the GKE Autopilot cluster, provisions a
   ...
   `windmill-data` bucket, builds the container image, and runs a one-shot
