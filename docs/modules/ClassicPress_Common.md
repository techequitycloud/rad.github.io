...
- [ClassicPress on Google Cloud Run](ClassicPress_CloudRun.md) — this configuration deployed on Cloud Run.
- [ClassicPress on GKE Autopilot](ClassicPress_GKE.md) — this configuration deployed on GKE.
