...
2. The `Services GCP` module deployed in the same project (provides VPC, GKE Autopilot cluster, Cloud SQL MySQL instance, and NFS server).
...
2. Cloud SQL instance provisioning (if not shared with Services GCP).
