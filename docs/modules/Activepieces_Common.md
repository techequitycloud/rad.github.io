...
description: "Shared configuration reference for the Activepieces module — application-layer settings consumed by both the Cloud Run and GKE Autopilot deployments."
---
