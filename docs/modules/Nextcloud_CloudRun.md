...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/Nextcloud_CloudRun.png" alt="Nextcloud on Google Cloud Run" style={{maxWidth: "100%", borderRadius: "8px"}} />
