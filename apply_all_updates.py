...
NAME_MAP = {
    ...
    "multitenancy": "multitenancy-saas",
    ...
    "multitenancy_saas": "multitenancy-saas",
    # outcomes
    "compliance": "compliance-governance",
    "cost_optimisation": "cost-optimization",
    "developer_productivity": "developer-productivity",
    "education": "skills-development",
    "operational_reliability": "modernization",
    "compliance_governance": "compliance-governance",
    "education_enablement": "skills-development",
    "modernisation": "modernization",
    "security_zero_trust": "zero-trust-security",
    # practices
    "gitops_iac": "gitops-iac",
    "platform_engineering": "idp",
    "platform-engineering": "idp",
    "developer-productivity": "idp",  # skip — no matching target
