...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/Wordpress_CloudRun.png" alt="WordPress on Google Cloud Run" style={{maxWidth: "100%", borderRadius: "8px"}} />
