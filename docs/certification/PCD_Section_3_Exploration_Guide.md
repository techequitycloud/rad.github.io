...
<img src="https://storage.googleapis.com/rad-public-2b65/certification/pcd_section3.png" alt="PCD Certification Preparation Guide: Section 3 — Deploying applications (~20% of the exam)" style={{maxWidth: "100%", borderRadius: "8px"}} />
