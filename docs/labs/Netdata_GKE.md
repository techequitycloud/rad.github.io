...
1. Open **Solutions → Solution Modules** in the RAD platform top navigation, open **Netdata
   ...
   Click **Deploy Module**, review the estimated cost in the confirmation dialog (if credits are enabled) and click **Confirm**,
