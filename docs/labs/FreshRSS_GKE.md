...
- **Services_GCP** (provides the VPC, GKE Autopilot cluster, Cloud SQL, NFS
  server, Artifact Registry, and shared service accounts this module depends
...
1. Open **Solutions → Solution Modules** in the RAD platform top navigation, open **FreshRSS (GKE)**
