...
- **Services_GCP** (provides the VPC, GKE Autopilot cluster, Cloud SQL, the
  co-located NFS/Redis VM, Artifact Registry, and shared service accounts this
...
1. Open **Solutions → Solution Modules** in the RAD platform top navigation, open **OnlyOffice (GKE)** from the **Platform Modules** list to start configuration, set `project_id`, and review the
