...
**Important:** The **Enable Subscription** setting must be turned on in the Global Configuration (Admin > Setup) for the Billing page to function. If subscriptions are disabled, the Billing page will display a warning and hide all controls.

## 3. Financial Management & Reporting

Navigate to the **Billing** page to access your toolset. The Billing page is organized into the following tabs:
...
### 3.5. Partner Revenue
See which partner-published modules are generating the most "True Revenue".
*   **True Revenue:** Defined as deployment costs paid for specifically with **Purchased Credits** (real money), excluding costs covered by free Awarded Credits.
*   **Share Calculation:** View the revenue share allocated to partners based on the configured percentage.

### 3.6. Agent Revenue
Track commissions and revenue driven by the Agent referral program.
*   **Commission Tracking:** Monitor the revenue generated by referred users and the commission owed to agents.
