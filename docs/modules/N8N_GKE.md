...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/N8N_GKE.png" alt="n8n on GKE Autopilot" style={{maxWidth: "100%", borderRadius: "8px"}} />
...
- [Hands-on lab: N8N on GKE Autopilot](../labs/N8N_GKE.md) — deploy it step by step, with the console screens and commands at each stage.
- [n8n on Google Cloud Run](N8N_CloudRun.md) — the same application on Cloud Run, for when you need the other deployment target.
- [N8N Common — Shared Application Configuration](N8N_Common.md) — the configuration shared by both deployment targets.
