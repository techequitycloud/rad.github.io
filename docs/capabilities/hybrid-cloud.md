...
- **Service Mesh** — `google_gke_hub_feature "service_mesh"` enables managed Istio across the fleet (`modules/Bank_GKE/asm.tf`, `modules/MC_Bank_GKE/asm.tf`). See [service-mesh](service-mesh).
