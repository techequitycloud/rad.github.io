...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/Activepieces_GKE.png" alt="Activepieces on GKE Autopilot" style={{maxWidth: "100%", borderRadius: "8px"}} />
...
- [Hands-on lab: Activepieces on GKE Autopilot](../labs/Activepieces_GKE.md) — deploy it step by step, with the console screens and commands at each stage.
- [Activepieces on Google Cloud Run](Activepieces_CloudRun.md) — the same application on Cloud Run, for when you need the other deployment target.
