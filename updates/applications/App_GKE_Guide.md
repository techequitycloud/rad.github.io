...
| `module_documentation` | `"https://docs.techequity.cloud/docs/applications/gke-app"` | Valid URL | URL shown as a help link in the platform UI. Update if you host your own documentation. |
