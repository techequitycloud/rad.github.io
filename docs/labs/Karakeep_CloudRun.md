...
- **Services_GCP** (provides the VPC, NFS/Filestore, Artifact Registry, and
...
platform can no longer manage it, use **Purge** instead (from the same **Delete** dialog) — it removes the
