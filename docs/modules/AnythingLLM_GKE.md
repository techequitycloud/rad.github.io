...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/AnythingLLM_GKE.png" alt="AnythingLLM on GKE Autopilot" style={{maxWidth: "100%", borderRadius: "8px"}} />
...
- [Hands-on lab: AnythingLLM on GKE Autopilot](../labs/AnythingLLM_GKE.md) — deploy it step by step, with the console screens and commands at each stage.
- [AnythingLLM on Google Cloud Run](AnythingLLM_CloudRun.md) — the same application on Cloud Run, for when you need the other deployment target.
