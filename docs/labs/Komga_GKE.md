...
- **Services_GCP** (provides the VPC, GKE Autopilot cluster, Artifact Registry,
  and shared service accounts this module depends on — Komga itself needs no
...
1. Open **Solutions → Solution Modules** in the RAD platform top navigation, open **Komga (GKE)**
