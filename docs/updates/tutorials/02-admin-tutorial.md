...
2.  **Organization:** Enter your Google Cloud **Organization ID**.
3.  **Billing:** Enter the **Billing Account ID** associated with your Google Cloud projects.
4.  **Scope:** Set the **Folder ID** where you want all projects to be created.
5.  **Features:** Check **Enable Credits** and **Enable Subscription**. This turns on the monetization engine.
6.  **Mail:** Enter your SMTP credentials so the system can send emails.
...
4.  In the **Awarded** column, add the amount (e.g., `1000`) to their current balance.
5.  Click **Save**.
