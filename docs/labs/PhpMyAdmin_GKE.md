...
- **Services_GCP** (provides the VPC, GKE Autopilot cluster, Cloud SQL, Artifact
  Registry, and shared service accounts this module depends on — and, if you
  want phpMyAdmin to administer it, the platform's shared MySQL instance). You
...
1. Open **Solutions → Solution Modules** in the RAD platform top navigation, open **PhpMyAdmin (GKE)** from
