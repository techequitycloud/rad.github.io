...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/Filebrowser_CloudRun.png" alt="Filebrowser on Google Cloud Run" style={{maxWidth: "100%", borderRadius: "8px"}} />
