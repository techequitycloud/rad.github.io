...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/Meilisearch_CloudRun.png" alt="Meilisearch on Google Cloud Run" style={{maxWidth: "100%", borderRadius: "8px"}} />
