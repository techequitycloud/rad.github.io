...
📌 **Case study connection — KnightMotives Automotive:** Section 4 topics (SDLC, business process optimisation, cost and capacity analysis, KPI measurement) map most directly to the KnightMotives Automotive case study. KnightMotives is transforming customer and dealer experiences using generative AI — which requires clearly defined business KPIs, optimised development workflows, and systematic cost modelling for AI workloads. As you explore this section, consider how you would apply CI/CD pipeline design and cost optimisation recommendations to an organisation transitioning from traditional software delivery to a continuous AI/ML model deployment cycle.
