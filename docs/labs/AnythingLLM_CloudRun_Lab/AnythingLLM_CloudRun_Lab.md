...
sidebar_label: "AnythingLLM CloudRun Lab"
---
...
2. The `Services_GCP` module deployed in the same project (provides VPC, Cloud SQL instance, and service accounts).
...
The four application secrets were created by `AnythingLLM_Common` on deployment:
