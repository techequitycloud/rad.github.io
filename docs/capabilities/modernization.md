...
`scripts/gcp-cr-mesh/gcp-cr-mesh.sh` shows the Cloud Run + mesh path — modernized workloads do not have to land on Kubernetes. See [serverless](serverless).
