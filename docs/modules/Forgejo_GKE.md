...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/Forgejo_GKE.png" alt="Forgejo on GKE Autopilot" style={{maxWidth: "100%", borderRadius: "8px"}} />
...
- [Hands-on lab: Forgejo on GKE Autopilot](../labs/Forgejo_GKE.md) — deploy it step by step, with the console screens and commands at each stage.
- [Forgejo on Google Cloud Run](Forgejo_CloudRun.md) — the same application on Cloud Run, for when you need the other deployment target.
