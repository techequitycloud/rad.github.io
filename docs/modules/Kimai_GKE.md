...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/Kimai_GKE.png" alt="Kimai on GKE Autopilot" style={{maxWidth: "100%", borderRadius: "8px"}} />
...
- [Hands-on lab: Kimai on GKE Autopilot](../labs/Kimai_GKE.md) — deploy it step by step, with the console screens and commands at each stage.
- [Kimai on Google Cloud Run](Kimai_CloudRun.md) — the same application on Cloud Run, for when you need the other deployment target.
