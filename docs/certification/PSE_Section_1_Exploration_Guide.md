...
<img src="https://storage.googleapis.com/rad-public-2b65/certification/pse_section1.png" alt="PSE Certification Preparation Guide: Section 1 — Configuring access (~25% of the exam)" style={{maxWidth: "100%", borderRadius: "8px"}} />
