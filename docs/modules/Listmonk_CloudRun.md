...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/Listmonk_CloudRun.png" alt="Listmonk on Google Cloud Run" style={{maxWidth: "100%", borderRadius: "8px"}} />
