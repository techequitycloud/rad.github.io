...
- [Hands-on lab: OpenEMR on GKE Autopilot](../labs/OpenEMR_GKE.md) — deploy it step by step, with the console screens and commands at each stage.
- [OpenEMR on Google Cloud Run](OpenEMR_CloudRun.md) — the same application on Cloud Run, for when you need the other deployment target.
