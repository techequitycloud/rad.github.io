...
Service-tier configuration is canonical in [capabilities/data-and-databases](data-and-databases).

### 3. AI workload runtime characteristics

- **Cloud Run for inference** — scale-to-zero suits spiky LLM traffic; per-second billing avoids paying for idle capacity. Runtime mechanics in [capabilities/serverless](serverless).
...
- [capabilities/data-and-databases](data-and-databases) — AlloyDB / pgvector / Elasticsearch / Filestore details
