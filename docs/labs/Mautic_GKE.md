...
1. Click **Deploy** in the RAD platform top navigation, open **Mautic (GKE)** from the **Platform Modules** list to start configuration, set `project_id`, and review the inputs.
