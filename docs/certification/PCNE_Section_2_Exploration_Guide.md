...
<img src="https://storage.googleapis.com/rad-public-2b65/certification/pcne_section2.png" alt="PCNE Certification Preparation Guide: Section 2 — Implementing a VPC network (~20% of the exam)" style={{maxWidth: "100%", borderRadius: "8px"}} />
