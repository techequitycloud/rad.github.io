...
<img src="https://storage.googleapis.com/rad-public-2b65/modules/LangFlow_CloudRun.png" alt="LangFlow on Google Cloud Run" style={{maxWidth: "100%", borderRadius: "8px"}} />
