...
| `resource_creator_identity` | *(platform SA)* | Service account email | Service account used by Terraform to create and manage resources. Override with a project-specific service account for production deployments. |
