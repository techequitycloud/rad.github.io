...
| Drupal-class CMS / Wiki | `Wikijs_CloudRun` / `Wikijs_GKE` + Cloud SQL |
...
- [capabilities/serverless.md](../capabilities/serverless.md) — Cloud Run / Autopilot as the replatform endpoint
- [capabilities/data_and_databases.md](../capabilities/data_and_databases.md) — managed-data substitutions
- [capabilities/disaster_recovery.md](../capabilities/disaster_recovery.md) — data-migration tooling
- [capabilities/networking.md](../capabilities/networking.md) — hybrid VPC and VMware Engine peering
- [practices/devsecops.md](../practices/devsecops.md) — security uplift controls
