...
- [Hands-on lab: Miniflux on Cloud Run](../labs/Miniflux_CloudRun.md) — deploy it step by step, with the console screens and commands at each stage.
- [Miniflux on GKE Autopilot](Miniflux_GKE.md) — the same application on Kubernetes, for when you need the other deployment target.
