...
- **Services_GCP** (provides the GKE Autopilot cluster, VPC, Cloud SQL, Artifact
...
1. In the RAD platform, open **Ghostfolio (GKE)**, set `project_id`, and review
   ...
   defaults to `true` and is REQUIRED — do not disable it. Click **Deploy Module**,
...
deployment). Delete removes everything the module created — the GKE Deployment and
