...
1. Click **Modules** in the RAD platform top navigation, open **Mattermost (GKE)** from the **Platform Modules** list to start configuration, set `project_id`, and review the inputs.
...
5. **Open a database session** for inspection or maintenance:
   ...
   gcloud sql connect "$INSTANCE" --user=mattermost --project="$PROJECT"
   ```
